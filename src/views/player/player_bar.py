...
from .position_editor import PositionEditorView
from .frame_id_editor import FrameIdEditorView
...
class PlayerBarView(QToolBar):
    def __init__(self, video: VideoModel|None=None, parent: QWidget|None = None):
        ...
        self._frame_id_editor = FrameIdEditorView()
        self.addWidget(self._frame_id_editor)
        self._position_editor = PositionEditorView()
