...
from src.models.timeseries_list import TimeseriesListModel
import os, json


class SaveAndLoad:
    def __init__(self, video_file: VideoFile, timeline_list: TimelineListModel, timeseries_list: TimeseriesListModel):
    ...
    def save_file(self, path: str):
        ...
        data = {
            ...
            "timeseries":   self._timeseries_list.data(),
        }
